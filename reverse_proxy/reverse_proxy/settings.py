...
OTP_TOTP_ISSUER = "Billmonitor"


# Application definition

INSTALLED_APPS = [
    "jet",  # 3rd party package for responsive admin templates (must be listed
...
if DEBUG:
    ...
    ADMINS = [(os.environ.get("ADMIN_USERNAME"), os.environ.get("ADMIN_EMAIL"))]
