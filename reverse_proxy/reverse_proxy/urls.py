...
urlpatterns += [
    url(r'^proxy-dashboard/select-site$', proxy_views.SelectSiteView.as_view(),
        name='select_site'),
    url(r'^proxy-dashboard/quick-select-site/(?P<site_name>[\w-]+)$',
        proxy_views.QuickSelectSiteView.as_view(), name='quick_select_site'),
